             ...
             <div class="card">
              ...
              <div class="tab-content p-3">
                  ...
                  <div class="tab-pane" id="edit">
                      <form action="{{route('update_profile',$client->id)}}" method="post">
                        @csrf
                        @method('PATCH')
                          <div class="form-group row">
                              <label class="col-lg-4 col-form-label form-control-label">Prénom</label>
                              <div class="col-lg-8">
                                  <input class="form-control" type="text" id="prenom_edit" name="prenom_edit" value="{{$client->prenom}}" required>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-lg-4 col-form-label form-control-label">Nom</label>
                              <div class="col-lg-8">
                                  <input class="form-control" type="text" name="nom_edit" value="{{$client->nom}}" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-lg-8">
                                  <input class="form-control" type="date" name="naissance_edit" value="{{$client->naissance}}" required>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-lg-4 col-form-label form-control-label">Sexe</label>
                              <div class="col-lg-8">
                                <select name="genre_edit"  id="genre_edit" class="form-control input-shadow">
                                    <option selected hidden value="{{$client->genre}}">{{$client->genre}}</option>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-lg-8">
                                <select name="pays_edit"   id="pays" class="form-control input-shadow">
                                    <option value="{{$client->pays}}" selected hidden>{{$client->pays}} </option>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-lg-8">
                                <select name="langue_edit" value="{{$client->langue}}" id="langue" class="form-control input-shadow">
                                <option value="English">English</option>    
                                <option value="Francais">Francais</option>
                                <option value="{{$client->langue}}" selected hidden>{{$client->langue}}</option>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-lg-8">
                                <input type="tel" required name="phone_edit" id="phone_edit" value="{{$client->telephone}}" class="form-control input-shadow" >
                              </div>
                          </div>
